            ...
            <section className='px-10 py-20 bg-[#F7F6F2]'>
                ...
                <div id="indicators-carousel" className="relative w-full mt-3" data-carousel="static">
                    ...
                    <div class="absolute z-30 flex -translate-x-1/2 space-x-3 rtl:space-x-reverse bottom-10 left-1/2">
                        <button type="button" className="w-6 h-6 bg-gray-300 hover:bg-green-700 rounded-full" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0"></button>
                        <button type="button" className="w-6 h-6 bg-gray-300 hover:bg-green-700 rounded-full" aria-current="false" aria-label="Slide 2" data-carousel-slide-to="1"></button>
                        <button type="button" className="w-6 h-6 bg-gray-300 hover:bg-green-700 rounded-full" aria-current="false" aria-label="Slide 3" data-carousel-slide-to="2"></button>
