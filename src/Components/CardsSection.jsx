        ...
        <>
            <section className="px-4 md:px-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
                    <img className="w-full h-auto rounded-lg object-cover" src="https://greenbee-2.myshopify.com/cdn/shop/files/img-1_1920x1920.jpg?v=1613769357" alt="" />
                    <img className="w-full h-auto rounded-lg object-cover" src="https://greenbee-2.myshopify.com/cdn/shop/files/img-2_1920x1920.jpg?v=1613769357" alt="" />
                    <img className="w-full h-auto rounded-lg object-cover" src="https://greenbee-2.myshopify.com/cdn/shop/files/img-3_1920x1920.jpg?v=1613769357" alt="" />
                </div>
